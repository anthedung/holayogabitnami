...
//start of a control box
        ...
        $this->add_control(
          'cat_exclude',
          [
             'label'       => __( 'Exclude Category with category ID, use " - " sign.', 'void' ),
             'label_block' => true,
             'type'        => Controls_Manager::TEXT,
             'description' => __( 'Get category id and add them here with a minus sign before them. Example : -1,-44,-3343', 'void' ),
             'placeholder' => __( '-1,-2,-33', 'void' ),
          ]
        );
