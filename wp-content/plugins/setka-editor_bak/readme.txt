...
Tags: Setka Editor, editor, post builder, page builder, gutenberg, grid, custom layout, rich text editor, custom fonts, wysiwyg, animation, adaptive
...
**[Watch the video →](https://vimeo.com/213249050)**
...
*Note: access to some of our features requires Setka Editor Pro Plans. You can check out what we have to offer [here](https://setka.io/pricing/).*
...
Installing Setka Editor is really easy and straightforward. However if you encounter any problems during the set-up process please reach out to us via [support channels](https://editor.setka.io/support).
...
2. Edit layout properties in the horizontal toolbar
3. Right click to access the context menu
4. Upload images to any part of the post. Scale and position them or use for backgrounds.
5. Add animations to increase engagement
6. Use inline icons for numbered lists without altering your HTML code
7. Preview posts in desktop and mobile view
8. Input license key here
9. Setka Editor settings in Wordpress
...
Please visit our [Help Center](https://editor-help.setka.io/) if you have questions on how to use Setka Editor features or troubleshoot any problem. If you have any feedback regarding our plugin, please contact us at [editor.setka.io/support](https://editor.setka.io/support).
...
Update the plugin to get access to our new features: post templates and snippet groups. Besides now you won’t accidentally loose your post design when switching between different post editors.
