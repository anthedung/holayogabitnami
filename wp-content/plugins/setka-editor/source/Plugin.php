...
class Plugin {
	...
	const DB_VERSION = 20170720130303;
	...
	public function run() {
        ...
        // Deactivation. Adds uninstall action.
		register_deactivation_hook($this->get_path(), array('\Setka\Editor\Service\Deactivation', 'run'));
		 ...
		 * @since 0.0.2
		 */
        add_action('uninstall_' . plugin_basename($this->get_path()), array('\Setka\Editor\Service\Uninstall', 'run'));
		...
		add_filter('cron_schedules', array('Setka\Editor\Service\CronSchedules', 'addSchedules'));
