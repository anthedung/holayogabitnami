...
class SavePost
{
     ...
     */
    public static function savePostAction($post_id, $post, $update)
    {
    ...
    public static function proceeding($settings, $post_id)
    {
        ...
        if(isset($settings['useSetkaEditor'])) {
            ...
            if('1' === $settings['useSetkaEditor'] || '0' === $settings['useSetkaEditor']) {
                ...
                if('1' === $settings['useSetkaEditor']) {
                    ...
                    if($created_in_setka_editor->getValue() !== '1') {
                        $task = new Cron\SetkaPostCreatedCronEvent();
                        $task->schedule();
                        $created_in_setka_editor->updateValue('1');
                    }
                }

                // Post created with Setka Editor
