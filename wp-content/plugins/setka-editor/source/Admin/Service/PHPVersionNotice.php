...
class PHPVersionNotice {
	...
	public static function renderNotice() {
		...
		<div id="setka-editor-notice-php-min-version" class="notice setka-editor-notice notice-error setka-editor-notice-error">
            ...
            <p><?php printf(
                    __('Oh, no! Seems you have an old PHP version that is not compatible with Setka Editor plugin. Please update your PHP plugin by following <a href="%1$s" target="_blank">these easy instructions</a> and then try activating the plugin again.', Plugin::NAME),
