...
{
    public function __construct($accountPage, $signUpPage)
    {
        if(Service\SetkaAccount\Account::isLoggedIn()) {
    ...
    public function fixMenu()
    {
        ...
        if(isset($submenu[$pageName][3][2]) && $submenu[$pageName][3][2] === $pageName . '-upgrade') {
            $submenu[$pageName][3][2] = Service\Config\PluginConfig::getUpgradeUrl(); // WPCS: override ok.
        }
    }
