...
class SignUpType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('companySize', Type\ChoiceType::class, array(
            ...
            'multiple' => false,
            'choices' => array(
                new NumberOfEmployees\Ranges\EmployeesRange1And5(),
                new NumberOfEmployees\Ranges\EmployeesRange6And20(),
                new NumberOfEmployees\Ranges\EmployeesRange21And50(),
                new NumberOfEmployees\Ranges\EmployeesRange51And150(),
                new NumberOfEmployees\Ranges\EmployeesRange151And300(),
                new NumberOfEmployees\Ranges\EmployeesRange301And1000(),
                new NumberOfEmployees\Ranges\EmployeesRange1001And5000(),
        ...
        $builder->add('whiteLabel', Type\CheckboxType::class, array(
            'label' => __('Show “Created with Setka Editor” credits below the content', Plugin::NAME),
            'required' => false,
            'validation_groups' => array('person', 'company'),
            'attr' => array(
                'data-form-element-role' => 'conditional-listener',
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
            $event->getForm()->add('config', Type\HiddenType::class, array(
                'data'=> wp_json_encode(FormConfig::getConfig($event->getForm()))
            ));
        });
    }
