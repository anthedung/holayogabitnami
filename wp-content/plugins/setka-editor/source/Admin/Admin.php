...
use Setka\Editor\Admin\MetaBoxes\DashBoardMetaBoxes;
use Setka\Editor\Admin\MetaBoxes\MetaBoxes;
...
class Admin {
	...
	public static function run() {
        ...
        require_once (PathsAndUrls::get_plugin_dir_path('source/libraries/polyfill-wordpress/bootstrap.php'));

        Service\Freemius::run();
        ...
        add_action('admin_init', array(MetaBoxes::class, 'run'));
        add_action('wp_dashboard_setup', array(DashBoardMetaBoxes::class, 'run'));
